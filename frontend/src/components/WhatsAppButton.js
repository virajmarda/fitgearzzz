...
const WhatsAppButton = () => {
  ...
  const phoneNumber = '+918668623252';
  ...
  return (
    <button
      ...
      className="fixed bottom-7 right-7 z-[60] flex items-center gap-2 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 shadow-lg shadow-emerald-500/40 px-4 py-2 text-sm font-semibold text-white focus:outline-none focus:ring-2 focus:ring-emerald-300"
    >
      {isHovered && (
        <span className="hidden sm:inline text-xs">Chat with us</span>
      )}
