...
<div id='product-component-1768552324196'></div>
...
(function () {
  ...
  function ShopifyBuyInit() {
    var client = ShopifyBuy.buildClient({
      ...
      storefrontAccessToken: '911c4899195860a45adc6954dd97db63',
    });
    ShopifyBuy.UI.onReady(client).then(function (ui) {
      ui.createComponent('product', {
        id: '9078771810530',
        node: document.getElementById('product-component-1768552324196'),
