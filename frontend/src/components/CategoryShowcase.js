...
// Category images — replace with your own CDN assets when ready
const CATEGORIES = [
  {
    name: 'Gym Equipment',
...
const CategoryShowcase = () => (
  <section className="bg-zinc-950 py-16">
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
      ...
      {/* Section header */}
      <div className="mb-10">
        <p className="text-orange-500 text-xs font-semibold uppercase tracking-[0.2em] mb-2">Shop by category</p>
